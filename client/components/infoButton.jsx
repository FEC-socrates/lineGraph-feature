...
class InfoButton extends React.Component {
  ...
  render() {
    ...
    return (
      <InfoButtonContainer width={this.props.width} onMouseOver={this.handleMouseOver} onMouseLeave={this.handleMouseLeave}>
        <Button>
          {icon}
          <Info>{this.props.value}</Info>
        </Button>
        {tooltip}
      </InfoButtonContainer>
    )
